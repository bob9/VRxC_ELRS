...
- **URL**: `/elrs_osd_config`
- **Access**: Via quick button in ELRS Settings panel ("Open OSD Configuration Page")

![OSD Configuration Menu Access](osd-config-menu-item.png)

![OSD Configuration Interface](osd-configuration.png)
